...
class Discriminator(nn.Module):
    ...
    def __init__(self, cont_dim):
        ...
        nn.init.normal_(self.convolve0.weight, std=0.447)
        ...
        nn.init.normal_(self.convolve1.weight, std=0.447)
        ...
        nn.init.normal_(self.convolve2.weight, std=0.447)
        ...
        nn.init.normal_(self.convolve3.weight, std=0.447)
        ...
        nn.init.normal_(self.convolve4.weight, std=0.447)
        ...
        nn.init.normal_(self.linear_classifier1.weight, std=0.447)
        nn.init.normal_(self.linear_classifier2.weight, std=0.447)
        nn.init.normal_(self.linear_classifier3.weight, std=0.447)
        nn.init.normal_(self.linear_classifier4.weight, std=0.447)
        nn.init.normal_(self.linear_classifier5.weight, std=0.447)
        ...
        nn.init.normal_(self.linear_projector1.weight, std=0.447)
        nn.init.normal_(self.linear_projector2.weight, std=0.447)
