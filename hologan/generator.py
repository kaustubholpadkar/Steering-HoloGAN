...
class Generator(nn.Module):
    ...
    def __init__(self):
        ...
        nn.init.normal_(self.mlp1.weight, std=0.447)
        torch.nn.init.zeros_(self.mlp1.bias)
        nn.init.normal_(self.dcv3d1.weight, std=0.447)
        ...
        nn.init.normal_(self.mlp2.weight, std=0.447)
        torch.nn.init.zeros_(self.mlp2.bias)
        nn.init.normal_(self.dcv3d2.weight, std=0.447)
        ...
        nn.init.normal_(self.dcv3d3.weight, std=0.447)
        torch.nn.init.zeros_(self.dcv3d3.bias)
        nn.init.normal_(self.dcv3d4.weight, std=0.447)
        ...
        nn.init.normal_(self.dcv2d1.weight, std=0.447)
        ...
        nn.init.normal_(self.mlp3.weight, std=0.447)
        torch.nn.init.zeros_(self.mlp3.bias)
        nn.init.normal_(self.dcv2d2.weight, std=0.447)
        ...
        nn.init.normal_(self.mlp4.weight, std=0.447)
        torch.nn.init.zeros_(self.mlp4.bias)
        nn.init.normal_(self.dcv2d3.weight, std=0.447)
